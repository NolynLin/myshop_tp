...
class NestedSets {
	/**
	 * @access private
	 * @var \Admin\Logic\DbMysql an instance of Db class for manipulating with database
	 */
	private $Db;
	/**
	 * @access private
	 ...
	 *
	 * @access public
	 * @param \Admin\Logic\DbMysql $Db an instance of Db class for manipulating with database
